...
//     var instrucaoSql = `
//         SELECT pontos, fkUsuario FROM score WHERE fkUsuario = ${idUsuario};
//     `;
//     console.log("Executando a instrução SQL: \n" + instrucaoSql);
//     return database.executar(instrucaoSql);
// }
...
// function editar(pontos,idUsuario) {
//     console.log("ACESSEI O Score MODEL \n \n\t\t >> Se aqui der erro de 'Error: connect ECONNREFUSED',\n \t\t >> verifique suas credenciais de acesso ao banco\n \t\t >> e se o servidor de seu BD está rodando corretamente. \n\n function editar(): ", pontos, idUsuario);
//     var instrucaoSql = `
//         UPDATE score SET pontos = ${pontos} WHERE fkUsuario = ${idUsuario};
//     `;
//     console.log("Executando a instrução SQL: \n" + instrucaoSql);
//     return database.executar(instrucaoSql);
// }

// function deletar(idScore) {
//     console.log("ACESSEI O Score MODEL \n \n\t\t >> Se aqui der erro de 'Error: connect ECONNREFUSED',\n \t\t >> verifique suas credenciais de acesso ao banco\n \t\t >> e se o servidor de seu BD está rodando corretamente. \n\n function deletar():", idScore);
//     var instrucaoSql = `
//         DELETE FROM Score WHERE id = ${idScore};
//     `;
//     console.log("Executando a instrução SQL: \n" + instrucaoSql);
//     return database.executar(instrucaoSql);
// }
